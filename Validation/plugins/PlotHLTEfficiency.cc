...
void HLTPlotter::makeEfficiencies()
{
    ...
    */
    ...
    l_eff_HLT_OR_pt_seeded->AddEntry( eff_HLT_OR_pt_seeded, "HLT_Photon30_IsoCaloID_OR_R9", "l" );
    l_eff_HLT_OR_pt_seeded->AddEntry( eff_HLT_Iso_pt_seeded, "HLT_Photon30_IsoCaloID", "l" );
    l_eff_HLT_OR_pt_seeded->AddEntry( eff_HLT_R9_pt_seeded, "HLT_Photon30_R9", "l" );
    l_eff_HLT_OR_pt_seeded->SetTextSize( 0.03 );
    l_eff_HLT_OR_pt_seeded->Draw();
    ...
    l_eff_HLT_OR_pt_unseeded->AddEntry( eff_HLT_OR_pt_unseeded, "HLT_Photon22_IsoCaloID_OR_R9", "l" );
    l_eff_HLT_OR_pt_unseeded->AddEntry( eff_HLT_Iso_pt_unseeded, "HLT_Photon22_IsoCaloID", "l" );
    l_eff_HLT_OR_pt_unseeded->AddEntry( eff_HLT_R9_pt_unseeded, "HLT_Photon22_R9", "l" );
    l_eff_HLT_OR_pt_unseeded->SetTextSize( 0.03 );
    ...
    */
    ...
    l_eff_HLT_OR_eta_unseeded->AddEntry( eff_HLT_OR_eta_unseeded, "HLT_Photon22_IsoCaloId_OR_R9ID", "l" );
    l_eff_HLT_OR_eta_unseeded->AddEntry( eff_HLT_Iso_eta_unseeded, "HLT_Photon22_IsoCaloId", "l" );
    l_eff_HLT_OR_eta_unseeded->AddEntry( eff_HLT_R9_eta_unseeded, "HLT_Photon22_R9Id", "l" );
    l_eff_HLT_OR_eta_unseeded->SetTextSize( 0.03 );
    ...
    */
    ...
    l_eff_HLT_OR_nvtx_unseeded->AddEntry( eff_HLT_OR_nvtx_unseeded, "HLT_Photon22_IsoCaloId_OR_R9ID", "l" );
    l_eff_HLT_OR_nvtx_unseeded->AddEntry( eff_HLT_Iso_nvtx_unseeded, "HLT_Photon22_IsoCaloId", "l" );
    l_eff_HLT_OR_nvtx_unseeded->AddEntry( eff_HLT_R9_nvtx_unseeded, "HLT_Photon22_R9Id", "l" );
    l_eff_HLT_OR_nvtx_unseeded->SetTextSize( 0.03 );
