...
class JobConfig(object):
    ...
    def __init__(self,*args,**kwargs):
        ...
        try:
            ...
            self.pu_distribs["80X_mcRun2_asymptotic_2016_v3"] = mix_2016_25ns #may need to double check as more 80x mc comes in.  good for now
        except Exception:
            print "Failed to load 80X mixing, this is expected in release <80X!"
                ...
                for name,obj in process.__dict__.iteritems():
                    ...
                    if putarget and not isdata:
                        ...
                        if puObj:
                            ...
                            puObj.puBins = cms.vdouble( map(float, samplepu.input.nbPileupEvents.probFunctionVariable) )
                            puObj.mcPu   = samplepu.input.nbPileupEvents.probValue
                            print puObj.mcPu
