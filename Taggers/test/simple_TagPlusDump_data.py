...
process.source = cms.Source ("PoolSource",fileNames = cms.untracked.vstring(
        ...
        "/store/group/phys_higgs/cmshgg/ferriff/flashgg/RunIISpring16DR80X-2_1_0-25ns_ICHEP16_p2/2_1_0/DoubleEG/RunIISpring16DR80X-2_1_0-25ns_ICHEP16_p2-2_1_0-v1-Run2016B-PromptReco-v2/160628_144334/0000/myMicroAODOutputFile_535.root"
...
process.untaggedTagDumper.src = "flashggUntagged" #needed because of stupid naming plans...
...
if customize.processType == "data" :
    ...
    JSONfile = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/Cert_271036-275783_13TeV_PromptReco_Collisions16_JSON.txt'
...
if customize.processType == "data" :
    ...
    vhtruth_variables=["hasZ := tagTruth().associatedZ ",
...
cfgTools.addCategories(process.vhHadronicTagDumper,
                       ...
                       variables=dipho_variables+ vhtruth_variables +
...
#process.p = cms.Path(process.flashggTagSequence*process.tthHadronicTagDumper*process.tthLeptonicTagDumper*process.vbfTagDumper*process.untaggedTagDumper)
#process.p = cms.Path(process.flashggTagSequence*process.tthHadronicTagDumper*process.tthLeptonicTagDumper*process.vbfTagDumper*process.untaggedTagDumper*process.flashggTagTester)
process.p = cms.Path(process.flashggTagSequence*process.vhEtTagDumper*process.vhHadronicTagDumper*process.vhTightTagDumper*process.vhLooseTagDumper*process.tthHadronicTagDumper*process.tthLeptonicTagDumper*process.vbfTagDumper*process.untaggedTagDumper)
